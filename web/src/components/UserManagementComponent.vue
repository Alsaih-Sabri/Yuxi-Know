    ...
    >
      <a-form layout="vertical" class="user-form">
        ...
        <a-form-item :label="$t('userManagement.role')" class="form-item">
          <a-select id="form_item_role" v-model:value="userManagement.form.role" size="large">
